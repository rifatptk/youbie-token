      ...
      <nav className="navigation-menu">
        <div className="container">
          <Link to="/" className="brand">
            <img src={logo} alt="Youbie" className="brand-logo" />
          </Link>
          <ul className="nav-menu__nav">
            <li className="nav-menu__nav-item">
              <HashLink to="/#introduction" className="nav-item-link">
                Introduction
              </HashLink>
            </li>

            <li className="nav-menu__nav-item">
              <HashLink to="/#nfts" className="nav-item-link">
                NFT Marketplace
              </HashLink>
            </li>

            <li className="nav-menu__nav-item">
              <HashLink to="/#features" className="nav-item-link">
                Features
              </HashLink>
            </li>

            <li className="nav-menu__nav-item">
              <HashLink to="/#streamers" className="nav-item-link">
                Streamers
              </HashLink>
            </li>
            ...
            <li className="nav-menu__nav-item">
              <a
                href="/files/YoubieWhitepaper.pdf"
                download
          ...
          <div className="user-group">
            <div className="cta-group">
              <HashLink to="/#go-premium" className="you-btn">
                Buy Premium
              </HashLink>
